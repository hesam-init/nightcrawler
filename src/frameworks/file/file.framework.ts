...
export class FileFramework {
   ...
   public static async writeHtmlToFile<T = string>(data: T, options: FileWriteOptions = {}): Promise<string> {
      try {
         const {
            prefix = "data",
            directory = "html-logs",
   ...
   public static async writeToFile(fileContent: string, filePath: string): Promise<void> {
      try {
